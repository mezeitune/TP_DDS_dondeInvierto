...
public class IndicadorVacioWindow extends Dialog<IndicadorVacioViewModel> {
	
	public IndicadorVacioWindow (WindowOwner owner) {
		super(owner, new IndicadorVacioViewModel());
	}
	protected void createFormPanel(Panel mainPanel) {
		...
		new Label(mainPanel).setText("Ingreso un indicador vacio �Desea volver a intentar cargarlo?");
