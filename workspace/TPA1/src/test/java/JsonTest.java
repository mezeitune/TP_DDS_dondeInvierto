...
public class JsonTest {
	ParserJsonAEmpresaAdapter adapter;//Adapter creado en el paquete usuario para que me devuelva la lista de empresas del archivo json
	
 	@Before
 	public void init() {
 		adapter = new ParserJsonAEmpresaAdapter("test.json");//archivo de tests
 	}
